...
def trainModel(model, train_loader, device):
    ...
    torch.save(model.state_dict(), "G:/AI Project/mask-classification-pytorch/saved_model/m1.pt")
...
def trainModel2(model, train_loader, device):
    ...
    print("Finished Training")
    torch.save(model.state_dict(), "C:/Users/ANUSHKA SHARMA/Desktop/Concordia/sem2/AAI/mask-classfication/saved_models/masknetv2_2.pt")
